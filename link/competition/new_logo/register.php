              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="POST" class="register-form" action="form/adminRegister.php" id="register-form">
                  <div class="form-group">
                    ...
                    <input name="uname" type="text" class="form-control form-control-lg " onchange = "validateUsername(this.value);" id="username"  placeholder="Username" required="">
            ...
            $.ajax ({
                ...
                success: function (response) {
                    ...
                    if (response == "Not available") {
                        ...
                        $('#username-message').html("Sorry! username already exists");
