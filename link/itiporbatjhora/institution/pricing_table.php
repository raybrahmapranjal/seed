    ...
    <div id="educo_wrapper">
        ...
        <div class="ed_transprentbg ed_toppadder80 ed_bottompadder50">
            <div class="container">
                ...
                <div class="ed_pricing_table_wrapper ed_bottompadder50 row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="ed_pricing_table">
                            ...
                            <div class="ed_pricing_tabel_footer">
                                <a href="javascript:void(0);" class="btn ed_btn ed_green">purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="ed_pricing_table_wrapper_second row">
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="ed_pricing_table">
                            ...
                            <div class="ed_pricing_tabel_footer">
                                <a href="javascript:void(0);" class="btn ed_btn ed_orange">purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
