                        ...
                        <div class="ed_blog_all_item">
                            <div class="ed_blog_item ed_bottompadder50">
                                <div class="ed_blog_image">
                                    <a href="blog_single.html"><img src="../assets/images/default/blog/blog_1.jpg" alt="blog image" /></a>
                                </div>
                                <div class="ed_blog_info">
                                    <h2><a href="blog_single.html">Are our teachers really skilled in all those areas?</a></h2>
                                    <ul>
                                    ...
                                    <p class="ed_bottompadder10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vehicula mauris ac facilisis congue. Fusce sem enim, rhoncus volutpat condimentum ac, placerat semper ligula. Suspendisse in viverra justo, eu placerat
                            ...
                            <div class="ed_blog_item ed_bottompadder50">
                                <div class="ed_blog_image">
                                    <a href="blog_single.html"><img src="../assets/images/default/blog/blog_2.jpg" alt="blog image" /></a>
                                </div>
                                <div class="ed_blog_info">
                                    <h2><a href="blog_single.html">How we care for our student education</a></h2>
                                    <ul>
                                        <li><a href="javascript:void(0);"><i class="fa fa-user"></i> Aaron Clay</a></li>
                                        <li><a href="javascript:void(0);"><i class="fa fa-clock-o"></i> July 12, 2018</a></li>
                                        <li><a href="javascript:void(0);"><i class="fa fa-comment-o"></i> 2 comments</a></li>
                                    </ul>
                                    <p class="ed_bottompadder10">Nulla orci nullam risus litora consequat id at hac molestie magna cursus magnis rhoncus sit cursus diam nunc ipsum sagittis lacus fringilla ridiculus ultricies nascetur. Praesent sed hac imperdiet massa, morbi duis
                                        quisque nunc proin interdum primis quam dictumst Cubilia Molestie. Donec Platea. Quis quis nonummy, etiam.</p>
                                    <a href="blog_single.html" class="btn ed_btn ed_orange">read more</a>
                                </div>
                            </div>
                            <div class="ed_blog_item ed_bottompadder50">
                                <div class="ed_blog_image">
                                    <a href="blog_single.html"><img src="../assets/images/default/blog/blog_3.jpg" alt="blog image" /></a>
                                </div>
                                <div class="ed_blog_info">
                                    <h2><a href="blog_single.html">Are our teachers really skilled in all those areas?</a></h2>
                                    <ul>
                                        <li><a href="javascript:void(0);"><i class="fa fa-user"></i> Crosby Ryder</a></li>
                                        <li><a href="javascript:void(0);"><i class="fa fa-clock-o"></i> August 22, 2018</a></li>
                                        <li><a href="javascript:void(0);"><i class="fa fa-comment-o"></i> 3 comments</a></li>
                                    </ul>
                                    <p class="ed_bottompadder10">Iaculis laoreet penatibus aliquam penatibus ac id ut tortor massa. At vestibulum mattis velit placerat mattis blandit diam. Morbi lectus risus curabitur ante nam.Ultricies. Arcu dapibus praesent est nunc bibendum ridiculus
                                        tellus. Aliquet rutrum mauris augue ac. Fringilla at suspendisse netus rhoncus nam curabitur.</p>
                                    <a href="blog_single.html" class="btn ed_btn ed_orange">read more</a>
                                </div>
                            </div>
                            <div class="col-lg-12">
