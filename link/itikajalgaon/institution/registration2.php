            ...
            <div class="ed_contact_form ed_toppadder60 row m-0">
                <div class="col-lg-12 col-md-12 col-sm-12">  
                    <div class="wrapper rounded bg-white"> 
                                <h4 class="widget-title">Alumni Registration form</h4>
                        ...
                        <p>(please provide your details)</p>                       
                            <form method="post" action="">
                                <div class="row clearfix">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                               <label>Year of joining<span class="asteriskField">*</span></label>
                                                <input type="text" class="form-control" required>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">                       
                                                ...
                                                <textarea name="" placeholder="" required="required" class="form-control"></textarea>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <label>state<span class="asteriskField">*</span></label>
                                                <input type="tel" class="form-control" required>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <label>pin<span class="asteriskField">*</span></label>
                                                <input type="tel" class="form-control" required>
                                        </div>
                                        ...
                                        <div class="btn btn-primary mt-3">register</div>
                                               <p class="mb-0 mt-3 text-center">already have an account? <a href="alumnilogin.php" class="btn-link">login here</a></p>
