				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Programs and Projects</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View Programs and Projects</li>
							</ol>
						</div>
					</div>
					<div class="row">
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser10) {
                                        	$n=0;
                                        	foreach ($readuser10 as $aboutKey) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form action="form/edit_programsprojects.php" method="post" enctype="multipart/form-data">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         ...
         success: function(response){
    		...
    		$('#deletePortfolio').attr("href","form/delete_programsprojects.php?id="+dataId);
