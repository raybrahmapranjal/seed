				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Telephone Directories</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View Telephone Directories</li>
							</ol>
						</div>
					</div>
					<div class="row">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser3) {
                                        	...
                                        	<tr>
												...
												<td><a href="<?php echo $aboutKey['id'];?>"  data-id="<?php echo $aboutKey['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form form action="form/edit_telephone.php" method="post" enctype="multipart/form-data">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         ...
         success: function(response){
    		...
    		$('#deletetelephone').attr("href","form/delete_telephone.php?id="+dataId);
