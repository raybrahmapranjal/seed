			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Honourable Dignities</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add Honourable Dignities</li>
							</ol>
						</div>
					</div>
				<form id="uploadForm" action="form/add_honourable.php" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Directory Information</header>
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" name="name" type="text" id="head">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" name="phone" type="text" id="title">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" name="shortdescription" type="text" id="title">
											<label class="mdl-textfield__label">shortdescription</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
