...
<?php include("include/top_section.php"); ?>
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">ABOUT BODOLAND SEED MISSION</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View ABOUT BODOLAND SEED MISSION</li>
							</ol>
						</div>
					</div>
					<div class="row">
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form action="form/edit_aboubodolandseed.php" method="post" enctype="multipart/form-data">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         type: "POST", 
         dataType: "json", 
         url: "xhr/fetch_aboubodolandseed.php", 
         data: {
            dataId:dataId         
         },
         success: function(response){
    		...
    		$('#deletePortfolio').attr("href","form/delete_aboubodolandseed.php?id="+dataId);
