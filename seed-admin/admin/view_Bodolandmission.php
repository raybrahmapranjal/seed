				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">BODOLAND SEED MISSION</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View BODOLAND SEED MISSION</li>
							</ol>
						</div>
					</div>
					<div class="row">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser7) {
                                        	...
                                        	<tr>
	                                        	...
	                                        	<td><?php echo $aboutKey['subtitle'] ;?></td>	
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form action="form/edit_Bodolandmission.php" method="post" enctype="multipart/form-data">
										...
										<div class="card-body row">
											...
											<div class="col-lg-6 p-t-20">
												<div
													...
													<input class="mdl-textfield__input"   name="subtitle" type="text"id="subtitle">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         ...
         success: function(response){
    		...
    		$("#title").val(keyed);
    		var keyed = response.subtitle.replace(/<br ?\/?>/g,"\n");
    		$("#subtitle").val(keyed);
    		...
    		$('#deletePortfolio').attr("href","form/delete_Bodolandmission.php?id="+dataId);
