				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser14) {
                                        	...
                                        	<tr>
	                                        	...
	                                        	<td><img width="100px" src="<?php echo $photos['image'];?>"></td>
	                                        	
	                                        	<td><?php echo $photos['description'] ;?></td>	
	                                        	<td><?php echo $photos['date_uploaded'];?></td>	
												...
												<td><a href="<?php echo $photos['id'];?>"  data-id="<?php echo $photos['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
															</a>
															<a href="javascript:void(0)"  data-id="<?php echo $photos['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         ...
         success: function(response){
    		...
    		$('#deletePortfolio').attr("href","form/delete_photos.php?id="+dataId);
