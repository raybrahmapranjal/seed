				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Honourable Dignitaries</div>
								 <?php 
		            ...
		            ?>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">View Honourable Dignitaries</li>
							</ol>
						</div>
					</div>
					<div class="row">
							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser22) {
                                        	$n=0;
                                        	foreach ($readuser22 as $honour) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td><img width="100px" src="<?php echo $honour['image'];?>"></td>
	                                        	<td><?php echo $honour['name'] ;?></td>	
	                                        	<td><?php echo $honour['phone'] ;?></td>	
	                                        	<td><?php echo $honour['shortdescription'] ;?></td>	
	                                        	<td><?php echo $honour['description'] ;?></td>	
	                                        	<td><?php echo $honour['date_uploaded'];?></td>	
	                                        	<!-- <td><a class="tblDelBtn" tabindex="0" aria-controls="example" type="button" a href="#" data-id="<?php echo $honour['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn"><span><i class="fa fa-pencil"></i> | <i class="fa fa-trash-o"></i></span></a>
												</td> -->
												<td><a href="<?php echo $honour['id'];?>"  data-id="<?php echo $honour['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
															</a>
															<a href="javascript:void(0)"  data-id="<?php echo $honour['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form form action="form/edit_honourable.php" method="post" enctype="multipart/form-data">
										...
										<div class="card-body row">
											...
											<div class="col-lg-6 p-t-20">
												<div
													class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
													<label >Phone</label>
													<input class="mdl-textfield__input" id="phone"    name="phone" type="text" >
											...
											<div class="col-lg-6 p-t-20">
												<div
													...
													<input class="mdl-textfield__input" id="shortdescription"  name="shortdescription" type="text" 
														id="title">
											...
											<div class="col-lg-12 p-t-20 text-center">
												...
												<button type="submit" name="formSubmit"
													...
													<a href="" id="deletetelephone" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-danger">DELETE <i class="fa fa-trash-o"></i></a>
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         ...
         success: function(response){
    		...
    		$("#phone").val(keyed);
    		var keyed = response.shortdescription.replace(/<br ?\/?>/g,"\n");
    		$("#shortdescription").val(keyed);
    		...
    		$('#deletetelephone').attr("href","form/delete_honourable.php?id="+dataId);
